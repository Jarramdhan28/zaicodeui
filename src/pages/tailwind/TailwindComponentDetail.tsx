...
import { componentIndex } from '../../data/component-tailwind/componentIndex'
import { categoryMeta } from '../../data/component-tailwind/categories'
...
const CategoryPage = () => {
  ...
  const components = componentIndex.filter(
